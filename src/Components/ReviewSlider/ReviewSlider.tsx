...
export default function ReviewSlider() {
  ...
  return (
    <>
      ...
      <div className="relative w-[100%] lg:w-[80%] my-3 glide-08">
        {/*    <!-- Slides --> */}
        <div
                    ...
                    <figure className="relative z-10">
                      <blockquote className="p-6 text- leading-loose lg:text-[18px] font-mont">
                        <p>
                          ...
                          And this is what I really love about being part of
                          something meaningful."
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-[#000]">
                        <span
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-left text-[#000]">
                          <img
                            src={maleuser}
                            alt="user name"
                            title="user name"
                          ...
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase font-mont">
                              Anna M.
                            </span>
                            {/* <cite className="not-italic font-mont">
                    ...
                    <figure className="relative z-10">
                      <blockquote className="p-6 text- leading-loose lg:text-[18px] font-mont">
                        <p>
                          ...
                          an environment that not only looks after nature but at
                          the same time nourishes a healthy lifestyle."
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-[#000]">
                        <span
